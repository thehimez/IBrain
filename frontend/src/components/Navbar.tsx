    ...
    <header className="h-14 flex items-center justify-between px-4 border-b border-navy-600 bg-navy-800/80 backdrop-blur-sm z-30 flex-shrink-0">
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          type="button"
          onClick={logout}
          className="inline-flex items-center gap-2 rounded-lg border border-slate-700 bg-slate-800/90 px-3 py-1.5 text-xs font-medium text-slate-200 hover:bg-slate-700 transition-colors"
        >
          <LogOut size={14} />
          <span>Logout</span>
        </button>
